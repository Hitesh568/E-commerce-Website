...
const Navbar = ({ handleOrderPopup }) => {
  ...
  <div className="bg-white rounded-full px-10 py-3 shadow-lg">
    <ul className="sm:flex hidden items-center gap-6">
      {Menu.map((data) => (
        <li key={data.id}>
          <a
            href={data.link}
            className="inline-block text-black hover:text-primary duration-200"
          >
            {data.name}
          </a>
        </li>
          ...
          <li className="group relative cursor-pointer">
            <div className="bg-white rounded-full px-10 py-3 shadow-lg"></div>
