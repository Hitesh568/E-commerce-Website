      ...
      <div className="container mx-auto px-4 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-300">
           Clothify is your ultimate fashion destination, offering the latest trends in clothing, accessories, and footwear — all at unbeatable prices with fast delivery.
          </p>
